      ...
      >
        ...
        <div className="flex flex-row items-start gap-1 sm:gap-2">
          <PromptInputTextarea
            ...
            className="ml-1 grow resize-none border-0! border-none! bg-transparent px-2 pt-1 pb-3 text-sm outline-none ring-0 [-ms-overflow-style:none] [scrollbar-width:none] placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 [&::-webkit-scrollbar]:hidden"
            rows={1}
            autoFocus
          />{' '}
          <Context {...contextProps} className="mt-1 mr-0.5" />
        </div>
